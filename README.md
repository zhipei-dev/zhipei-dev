...
A GitHub-native Action that deterministically checks whether a repository contains the evidence needed for client, developer, or operations handoff. It runs without an LLM or hosted backend, produces explainable readiness results, and is released as [`v1.1.0`](https://github.com/zhipei-dev/delivery-readiness-guard/releases/tag/v1.1.0) on the GitHub Marketplace with a maintained `v1` major tag. It is continuously dogfooded across four public portfolio repositories.

**Stack:** TypeScript, Node.js 24, GitHub Actions, YAML, @actions/core, ncc

---

### [API Rescue Case Study](https://github.com/zhipei-dev/api-rescue-case-study)

[![CI](https://github.com/zhipei-dev/api-rescue-case-study/actions/workflows/ci.yml/badge.svg)](https://github.com/zhipei-dev/api-rescue-case-study/actions/workflows/ci.yml)
...
### [Operations Reconciliation Toolkit](https://github.com/zhipei-dev/ops-reconciliation-toolkit)

[![CI](https://github.com/zhipei-dev/ops-reconciliation-toolkit/actions/workflows/ci.yml/badge.svg)](https://github.com/zhipei-dev/ops-reconciliation-toolkit/actions/workflows/ci.yml)
...
### [Business Operations Mini Platform](https://github.com/zhipei-dev/business-ops-mini-platform)

[![CI](https://github.com/zhipei-dev/business-ops-mini-platform/actions/workflows/ci.yml/badge.svg)](https://github.com/zhipei-dev/business-ops-mini-platform/actions/workflows/ci.yml)
